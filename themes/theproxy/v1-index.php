...
<section class="list">
    ...
    <div class="row">
        <div class="col s12">
            <a class="right" href="<?php echo BASE_URL . 'v1/' . 'download' ?>" onclick="Materialize.toast('Download Iniciado', 4000)" target="_blank">Fazer download do arquivo</a>
            <a class="right" href="<?php echo BASE_URL . 'v1/' . 'aes' ?>" style="margin-right: 10px;padding-right: 10px;border-right: 1px solid #CCCCCC;">Ver dados criptografados</a>
            <a class="right" href="<?php echo BASE_URL . 'v1/' . 'importar' ?>" style="margin-right: 10px;padding-right: 10px;border-right: 1px solid #CCCCCC;">Importar dados</a>
            <a class="right" href="<?php echo BASE_URL ?>" style="margin-right: 10px;padding-right: 10px;border-right: 1px solid #CCCCCC;">Ir para o Cadastro de Regras</a>
        </div>
    </div>
</section>
